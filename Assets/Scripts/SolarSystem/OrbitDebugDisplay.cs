...
public class OrbitDebugDisplay : MonoBehaviour 
{
        ...
        for (int bodyIndex = 0; bodyIndex < virtualBodies.Length; bodyIndex++) {
            ...
            if (useThickLines) {
                ...
                for (int i = 0; i < drawPoints[bodyIndex].Length - 1; i++) {
                    ...
                    Debug.DrawLine (drawPoints[bodyIndex][i], drawPoints[bodyIndex][i + 1], Color.blue);
                }
    ...
    Vector3 CalculateAcceleration (int i, VirtualBody[] virtualBodies) {
        ...
        for (int j = 0; j < virtualBodies.Length; j++) {
            ...
            acceleration += forceDir * SolarSystemGenerator.gravitationalConstant * virtualBodies[j].mass / sqrDst;
        }
        return acceleration;
    }
    ...
    void OnValidate () {
        if (usePhysicsTimeStep) {
            timeStep = SolarSystemGenerator.physicsTimeStep;
        }
    }
